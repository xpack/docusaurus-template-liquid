...
const sidebars: SidebarsConfig = {
  ...
  docsSidebar: [
    ...
    userSidebarCategory,{% else %}
    {
      ...
      id: 'user/index',
      label: 'User\'s Guide'
    },{% endif %}{% if packageWebsiteConfig.customFields.isOrganizationWeb != "true" %}
    {
      type: 'doc',
      id: 'developer/index',
  ...
  testsSidebar: [{type: 'autogenerated', dirName: 'tests'}],{% endif %}{% if packageWebsiteConfig.customFields.isOrganizationWeb == "true" %}
  toolsSidebar,{% endif %}
};
