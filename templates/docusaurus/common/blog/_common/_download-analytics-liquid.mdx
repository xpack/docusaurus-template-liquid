...
{%- if websiteConfig.showDeprecatedGnuMcuAnalytics %}
...
{%- endif %}
{%- if websiteConfig.showDeprecatedRiscvGccAnalytics %}
...
Credit to [Shields IO](https://shields.io) for the badges{% if isXpackBinary %} and to
