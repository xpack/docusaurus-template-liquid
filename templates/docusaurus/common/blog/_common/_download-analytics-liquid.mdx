...
- npmjs.com [{{packageScopedName}}](https://www.npmjs.com/package/{{packageScopedName}})
  - last month downloads [![NPM Downloads](https://img.shields.io/npm/dw/{% if packageScope != "" %}%40{{packageScope}}%2F{% endif %}{{packageName}})](https://www.npmjs.com/package/{{packageScopedName}}/)
  - total downloads [![NPM Downloads](https://img.shields.io/npm/d18m/{% if packageScope != "" %}%40{{packageScope}}%2F{% endif %}{{packageName}})](https://www.npmjs.com/package/{{packageScopedName}}/)
{%- if packageWebsiteConfig.showDeprecatedGnuMcuAnalytics == 'true' %}
