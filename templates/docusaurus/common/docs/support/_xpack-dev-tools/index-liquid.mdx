...
[GitHub Discussions](https://github.com/xpack-dev-tools/{{gitHubProjectName}}/discussions/) pages.
...
- check the [GitHub Discussions](https://github.com/xpack-dev-tools/{{gitHubProjectName}}/discussions/) for
similar topics
- check the
[GitHub Issues](https://github.com/xpack-dev-tools/{{gitHubProjectName}}/issues/)
