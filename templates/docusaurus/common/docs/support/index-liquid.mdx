...
please share them through the{% if packageConfig.isOrganizationWeb == "true" %}
GitHub Discussions pages. Use the top-level
[GitHub Discussions](https://github.com/{{githubProjectOrganization}}/{{githubProjectName}}/discussions)
page for issues related to the main xPack Project site, or the individual project’s GitHub Discussions pages for specific projects.{% else %}
[GitHub Discussions](https://github.com/{{githubProjectOrganization}}/{{githubProjectName}}/discussions)
pages.
{% endif %}
