...
# How to get help for the {% if packageConfig.descriptiveLongName %}{{packageConfig.descriptiveLongName}}{% else %}{{packageConfig.descriptiveName}}{% endif %}

{%- else %}

# How to get help for an unsupported organization
