...
# How to get help for {% if packageWebsiteConfig.shortName %}{{packageWebsiteConfig.shortName}}{% else %}the {{packageWebsiteConfig.longName}}{% endif %}

{% if packageConfig.isOrganizationWeb == "true" %}
## Quick tips

The **{{packageWebsiteConfig.longName}}** consists of multiple individual
