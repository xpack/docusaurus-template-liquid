...
[![GitHub package.json version](https://img.shields.io/github/package-json/v/{{githubProjectOrganization}}/{{githubProjectName}}?color=green)](https://github.com/{{githubProjectOrganization}}/{{githubProjectName}}/blob/mater/package.json)
...
# How to make new {% if packageWebsiteConfig.shortName %}{{packageWebsiteConfig.shortName}}{% else %}{{packageWebsiteConfig.longName}}{% endif %} releases
...
```sh
npm --prefix ~/Work/npm-packages/{{githubProjectName}}.git/website run clean
npm --prefix ~/Work/npm-packages/{{githubProjectName}}.git/website run start
```
...
```sh
npm --prefix ~/Work/npm-packages/{{githubProjectName}}.git/website run generate-website-blog-post
```
...
npm --prefix ~/tmp/{{packageName}}-test install {{packageScopedName}}@next
```
{% else %}
...
```sh
npm --prefix ~/Work/npm-packages/{{githubProjectName}}.git/website run build
```
...
- <code>npm dist-tag add {{packageScopedName}}@{customField('releaseVersion')} latest</code>
- `npm dist-tag ls {{packageScopedName}}`
