...
[![GitHub package.json version](https://img.shields.io/github/package-json/v/{{githubProjectOrganization}}/{{githubProjectName}})](https://github.com/{{githubProjectOrganization}}/{{githubProjectName}}/blob/mater/package.json)
[![npm (scoped)](https://img.shields.io/npm/v/@{{packageScope}}/{{packageName}}.svg)](https://www.npmjs.com/package/@{{packageScope}}/{{packageName}}/)
...
# How to make new xPack {{packageWebsiteConfig.name}} releases

This page is designed for maintainers of the
**xPack {{packageWebsiteConfig.name}}**
...
```sh
npm --prefix ~/Work/npm-modules/{{githubProjectName}}.git/website run clean
npm --prefix ~/Work/npm-modules/{{githubProjectName}}.git/website run start
```
...
```sh
npm --prefix ~/Work/npm-modules/{{githubProjectName}}.git/website run generate-website-blog-post
```
...
```sh
npm --prefix ~/Work/npm-modules/{{githubProjectName}}.git publish --tag next
```
...
[@{{packageScope}}/{{packageName}} Versions](https://www.npmjs.com/package/@{{packageScope}}/{{packageName}}?activeTab=versions).
...
```bash
rm -rf ~/tmp/{{packageName}}-test && mkdir ~/tmp/{{packageName}}-test
npm --prefix ~/tmp/{{packageName}}-test init
npm --prefix ~/tmp/{{packageName}}-test install @{{packageScope}}/{{packageName}}@next
```

Validate the web site content in a local build via the npm `build` script:

```sh
npm --prefix ~/Work/npm-modules/{{githubProjectName}}.git/website run build
```
...
- `npm dist-tag ls @{{packageScope}}/{{packageName}}`
- <code>npm dist-tag add @{{packageScope}}/{{packageName}}@{customField('npmVersion')} latest</code>
- `npm dist-tag ls @{{packageScope}}/{{packageName}}`

## Analytics

- npmjs.com [`@{{packageScope}}/{{packageName}}`](https://www.npmjs.com/package/@{{packageScope}}/{{packageName}}/) package
  - latest release, per month
[![npm (scoped)](https://img.shields.io/npm/v/@{{packageScope}}/{{packageName}}.svg)](https://www.npmjs.com/package/@{{packageScope}}/{{packageName}}/)
[![npm](https://img.shields.io/npm/dm/@{{packageScope}}/{{packageName}}.svg)](https://www.npmjs.com/package/@{{packageScope}}/{{packageName}}/)
  - all releases [![npm](https://img.shields.io/npm/dt/@{{packageScope}}/{{packageName}}.svg)](https://www.npmjs.com/package/@{{packageScope}}/{{packageName}}/)
