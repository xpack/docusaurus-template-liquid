...
<CodeBlock language="sh"> {
`npm dist-tag add {{packageScopedName}}@${customField('xpackVersion')}.${customField('npmSubversion')} latest
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish {{packageScopedName}}@${customField('xpackVersion')}.${customField('npmSubversion')}
`} </CodeBlock>
