...
# How to make new xPack {{appName}} releases
...
named like **xPack {{appName}} v{customField('xpackVersion')}** (mind the dash),
...
<a href="https://www.npmjs.com/package/@xpack-dev-tools/{{appLcName}}?activeTab=versions">npmjs.com</a>.
...
<CodeBlock language="sh"> {
`npm dist-tag add @xpack-dev-tools/{{appLcName}}@${customField('xpackVersion')}.${customField('npmSubversion')} latest
`} </CodeBlock>

Check the result:

<CodeBlock language="sh"> {
`npm dist-tag ls @xpack-dev-tools/{{appLcName}}
`} </CodeBlock>

In case the release proves problematic and needs to be unpublished:

<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/{{appLcName}}@${customField('xpackVersion')}.${customField('npmSubversion')}
`} </CodeBlock>
...
- paste the release name like _**xPack {{appName}} v{customField('xpackVersion')} released**_
...
[![Github All Releases](https://img.shields.io/github/downloads/xpack-dev-tools/{{gitHubProjectName}}/latest/total.svg)](https://github.com/xpack-dev-tools/{{gitHubProjectName}}/releases/)
  ...
  - previous GNU MCU Eclipse all releases [![Github All Releases](https://img.shields.io/github/downloads/gnu-mcu-eclipse/{{appLcName}}/total.svg)](https://github.com/gnu-mcu-eclipse/{{appLcName}}/releases/){% endif %}
...
- npmjs.com [`@xpack-dev-tools/{{appLcName}}`](https://www.npmjs.com/package/@xpack-dev-tools/{{appLcName}}/) xPack
  - latest release, per month
[![npm (scoped)](https://img.shields.io/npm/v/@xpack-dev-tools/{{appLcName}}.svg)](https://www.npmjs.com/package/@xpack-dev-tools/{{appLcName}}/)
[![npm](https://img.shields.io/npm/dm/@xpack-dev-tools/{{appLcName}}.svg)](https://www.npmjs.com/package/@xpack-dev-tools/{{appLcName}}/)
  - all releases [![npm](https://img.shields.io/npm/dt/@xpack-dev-tools/{{appLcName}}.svg)](https://www.npmjs.com/package/@xpack-dev-tools/{{appLcName}}/)
