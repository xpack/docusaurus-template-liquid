...
title: Maintainer's Guide{% if customFields.usePluralGuides == "true" %}s{% endif %}
...
keywords:
  ...
  - build{% if customFields.hasCustomMaintainer != "true" %}
  - releases
  - publish
  - npmjs{% endif %}
...
{% if customFields.hasCustomMaintainer == "true" %}

import CustomMaintainer from './_custom-maintainer.mdx'

{/* ------------------------------------------------------------------------ */}

# Maintainer's Guide{% if customFields.usePluralGuides == "true" %}s{% endif %}
