...
<code>arm-gnu-toolchain-{versionMajor()}.{versionMinor()}.rel{customField('armSubRelease')}-darwin-x86_64-{{packageWebsiteConfig.customFields.triplet}}.tar.xz</code>)
- unpack the archive
...
(<code>{versionMajor()}.{versionMinor()}.rel{customField('armSubRelease')}-darwin-x86_64-{{packageWebsiteConfig.customFields.triplet}}-manifest.txt</code>) to the new folder in extras
