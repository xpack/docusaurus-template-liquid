...
{%- if platform == "linux-arm64" %}{% assign names_array = names_array | concat: "berry5" %}{% assign dual_runner = true %}{% assign dual_runners_array = dual_runners_array | concat: "berry5" %}{% endif %}
{%- endfor %}
