...
# About the xPack {{packageConfig.longName}}

{%- if packageWebsiteConfig.customFields.isOrganizationWeb != "true" %}

## The project

The **xPack {{packageConfig.longName}}** project is part of the
...
For all correspondence related to {% if packageWebsiteConfig.customFields.isOrganizationWeb == "true" %}the
**xPack {{packageConfig.longName}}** projects, kindly use the support pages of each individual project{% else%}the **xPack {{packageConfig.longName}}**
