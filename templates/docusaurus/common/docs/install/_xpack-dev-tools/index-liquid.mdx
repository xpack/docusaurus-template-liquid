...
<ul>
{%- if isMacOSX64 %}
<li><code>xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}-darwin-x64.tar.gz</code></li>
{%- endif %}
{%- if isMacOsArm64 %}
<li><code>xpack-{{packageConfig.shortName}}-{{xpackVersion}}-darwin-arm64.tar.gz</code></li>
{%- endif %}
</ul>
...
<ul>
{%- if isLinuxX64 %}
<li><code>xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}-linux-x64.tar.gz</code></li>
{%- endif %}
{%- if isLinuxArm64 %}
<li><code>xpack-{{packageConfig.shortName}}-{{xpackVersion}}-linux-arm64.tar.gz</code></li>
{%- endif %}
{%- if isLinuxArm %}
<li><code>xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}-linux-arm.tar.gz</code></li>
{%- endif %}
</ul>
