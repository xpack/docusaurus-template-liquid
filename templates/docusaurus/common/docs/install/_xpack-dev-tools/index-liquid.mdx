...
title: Install Guide{% if customFields.usePluralGuides == "true" %}s{% endif %}
...
keywords:
  ...
  - prerequisites
  - automated
  - install{% if customFields.hasCustomInstall != "true" %}
  - uninstall
  - files{% endif %}
...
{% if customFields.hasCustomInstall == "true" %}

import CustomInstall from './_custom-install.mdx'

{/* ------------------------------------------------------------------------ */}

# Install Guide{% if customFields.usePluralGuides == "true" %}s{% endif %}
