...
keywords:
  ...
  - prerequisites
  - automated
  - install{% if packageWebsiteConfig.hasCustomInstall != "true" %}
  - uninstall
  - files{% endif %}
...
# Install Guide{% if packageWebsiteConfig.usePluralGuides == "true" %}s{% endif %}
...
[![npm (scoped)](https://img.shields.io/npm/v/%40xpack-dev-tools%2F{{packageName}}?label=xpm&color=blue)](https://www.npmjs.com/package/{{packageScopedName}}/)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/{{githubProjectOrganization}}/{{githubProjectName}}/total)
[![npm](https://img.shields.io/npm/dm/%40xpack-dev-tools%2F{{packageName}}?label=xpm%20downloads)](https://www.npmjs.com/package/{{packageScopedName}}/)
...
<CodeBlock language="sh"> {
`xpm install {{packageScopedName}}@${customField('releaseVersion')} --verbose
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/{{packageName}}/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/{{packageName}}/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/{{packageScopedName}}/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-{{packageConfig.shortName}}-{customField('xpackVersion')}-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\{{packageName}}\\xpack-{{packageConfig.shortName}}-{customField('xpackVersion')}</code>.
...
<ul>
{% if isMacOSX64 %}<li><code>xpack-{{packageConfig.shortName}}-{customField('xpackVersion')}-darwin-x64.tar.gz</code></li>{% endif %}
{% if isMacOsArm64 %}<li><code>xpack-{{packageConfig.shortName}}-{customField('xpackVersion')}-darwin-arm64.tar.gz</code></li>{% endif %}
</ul>
...
example <code>/Users/ilg/Library/xPacks/{{packageName}}/xpack-{{packageConfig.shortName}}-{customField('xpackVersion')}</code>:
...
<ul>
{% if isLinuxX64 %}<li><code>xpack-{{packageConfig.shortName}}-{customField('xpackVersion')}-linux-x64.tar.gz</code></li>{% endif %}
{% if isLinuxArm64 %}<li><code>xpack-{{packageConfig.shortName}}-{customField('xpackVersion')}-linux-arm64.tar.gz</code></li>{% endif %}
{% if isLinuxArm %}<li><code>xpack-{{packageConfig.shortName}}-{customField('xpackVersion')}-linux-arm.tar.gz</code></li>{% endif %}
</ul>
...
example <code>/home/ilg/.local/xPacks/{{packageName}}/xpack-{{packageConfig.shortName}}-{customField('xpackVersion')}</code>:
