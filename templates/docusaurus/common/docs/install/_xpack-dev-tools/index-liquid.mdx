...
# How to install the {{longXpackName}}
...
<ul>
<li><code>xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\{{packageName}}\\xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}</code>.
...
<ul>
{% if isMacOSX64 %}<li><code>xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}-darwin-x64.tar.gz</code></li>{% endif %}
{% if isMacOsArm64 %}<li><code>xpack-{{packageConfig.shortName}}-{{xpackVersion}}-darwin-arm64.tar.gz</code></li>{% endif %}
</ul>
...
example <code>/Users/ilg/Library/xPacks/{{packageName}}/xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/{{packageName}}
cd ~/Library/xPacks/{{packageName}}

tar xvf ~/Downloads/xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}-darwin-x64.tar.gz
chmod -R -w xpack-{{packageConfig.shortName}}-{{xpackVersion}}
`} </CodeBlock>
...
<ul>
{% if isLinuxX64 %}<li><code>xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}-linux-x64.tar.gz</code></li>{% endif %}
{% if isLinuxArm64 %}<li><code>xpack-{{packageConfig.shortName}}-{{xpackVersion}}-linux-arm64.tar.gz</code></li>{% endif %}
{% if isLinuxArm %}<li><code>xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}-linux-arm.tar.gz</code></li>{% endif %}
</ul>
...
example <code>/home/ilg/.local/xPacks/{{packageName}}/xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/{{packageName}}
cd ~/.local/xPacks/{{packageName}}

tar xvf ~/Downloads/xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}-linux-x64.tar.gz
chmod -R -w xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{xpackVersion}}
`} </CodeBlock>
