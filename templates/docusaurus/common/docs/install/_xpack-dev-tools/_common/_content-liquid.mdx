...
<ul>
<li><code>xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{releaseSemver}}-{{releaseSubversion}}-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\{{packageName}}\\xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{releaseSemver}}-{{releaseSubversion}}</code>.
...
<ul>
{%- if isMacOSX64 %}
<li><code>xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{releaseSemver}}-{{releaseSubversion}}-darwin-x64.tar.gz</code></li>
{%- endif %}
{%- if isMacOsArm64 %}
<li><code>xpack-{{packageConfig.shortName}}-{{releaseSemver}}-{{releaseSubversion}}-darwin-arm64.tar.gz</code></li>
{%- endif %}
</ul>
...
example <code>/Users/ilg/Library/xPacks/{{packageName}}/xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{releaseSemver}}-{{releaseSubversion}}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/{{packageName}}
cd ~/Library/xPacks/{{packageName}}

tar xvf ~/Downloads/xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{releaseSemver}}-{{releaseSubversion}}-darwin-x64.tar.gz
chmod -R -w xpack-{{packageConfig.shortName}}-{{releaseSemver}}-{{releaseSubversion}}
`} </CodeBlock>
...
<ul>
{%- if isLinuxX64 %}
<li><code>xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{releaseSemver}}-{{releaseSubversion}}-linux-x64.tar.gz</code></li>
{%- endif %}
{%- if isLinuxArm64 %}
<li><code>xpack-{{packageConfig.shortName}}-{{releaseSemver}}-{{releaseSubversion}}-linux-arm64.tar.gz</code></li>
{%- endif %}
{%- if isLinuxArm %}
<li><code>xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{releaseSemver}}-{{releaseSubversion}}-linux-arm.tar.gz</code></li>
{%- endif %}
</ul>
...
example <code>/home/ilg/.local/xPacks/{{packageName}}/xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{releaseSemver}}-{{releaseSubversion}}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/{{packageName}}
cd ~/.local/xPacks/{{packageName}}

tar xvf ~/Downloads/xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{releaseSemver}}-{{releaseSubversion}}-linux-x64.tar.gz
chmod -R -w xpack-{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}-{{releaseSemver}}-{{releaseSubversion}}
`} </CodeBlock>
