...
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\@{{packageScope}}\\${props.shortName}\\${customField('xpackVersion')}.${customField('npmSubversion')}\\.content\\bin\\${props.programName}.exe --version
...
<CodeBlock language="console"> {
`% ~/Library/xPacks/@{{packageScope}}/${props.shortName}/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin/${props.programName} --version
${props.branding}${customField('upstreamVersion')}
`} </CodeBlock>
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/@{{packageScope}}/${props.shortName}/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin/${props.programName} --version
${props.branding}${customField('upstreamVersion')}
`} </CodeBlock>
