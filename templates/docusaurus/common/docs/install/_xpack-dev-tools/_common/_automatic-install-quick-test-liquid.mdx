...
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\@{{packageScope}}\\${props.permalinkName}\\{{releaseVersion}}\\.content\\bin\\${props.programName}.exe --version
...
<CodeBlock language="console"> {
`% ~/Library/xPacks/@{{packageScope}}/${props.permalinkName}/{{releaseVersion}}/.content/bin/${props.programName} --version
${props.branding}{{upstreamVersion}}
`} </CodeBlock>
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/@{{packageScope}}/${props.permalinkName}/{{releaseVersion}}/.content/bin/${props.programName} --version
${props.branding}{{upstreamVersion}}
`} </CodeBlock>
