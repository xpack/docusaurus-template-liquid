...
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\${props.shortName}\\xpack-${props.shortName}-{{releaseSemver}}-{{releaseSubversion}}\\bin\\${props.programName}.exe --version
...
<CodeBlock language="console"> {
`% ~/Library/xPacks/${props.shortName}/xpack-${props.shortName}-{{releaseSemver}}-{{releaseSubversion}}/bin/${props.programName} --version
${props.branding}{{upstreamVersion}}
`} </CodeBlock>
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/${props.shortName}/xpack-${props.shortName}-{{releaseSemver}}-{{releaseSubversion}}/bin/${props.programName} --version
${props.branding}{{upstreamVersion}}
`} </CodeBlock>
