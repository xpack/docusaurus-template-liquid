...
With the environment properly set, the command to install **{{packageWebsiteConfig.shortName}}** is:
...
The result of installing **{{packageWebsiteConfig.shortName}}** is a set of files in the `%APPDATA%\npm` folder:
...
29/07/2024  07:24               397 {{packageName}}
29/07/2024  07:24               329 {{packageName}}.cmd
29/07/2024  07:24               821 {{packageName}}.ps1
...
<CodeBlock language="console"> {
`% which {{packageName}}
/Users/ilg/.nvm/versions/node/${props.nodeVersion}/bin/{{packageName}}
`} </CodeBlock>

To test if **{{packageWebsiteConfig.shortName}}** starts:
...
<CodeBlock language="console"> {
`$ which {{packageName}}
/home/ilg/.nvm/versions/node/${props.nodeVersion}/bin/{{packageName}}
$ {{packageName}} --version
${customField('releaseVersion')}
`} </CodeBlock>
...
The command to remove **{{packageWebsiteConfig.shortName}}** is:
...
If, for any reason, you decide not to install **{{packageWebsiteConfig.shortName}}**, you can still
benefit from it by using the `npx` command, as a trampoline to start **{{packageWebsiteConfig.shortName}}**:
