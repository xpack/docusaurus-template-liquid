...
Installing **{% if topConfig.permalinkName != '' %}{{topConfig.permalinkName}}{% else %}{{packageName}}{% endif %}** requires:
...
also **xpm**{% if topConfig.permalinkName == 'xpm' %}, allowing you to safely skip the next section{% endif %}.
