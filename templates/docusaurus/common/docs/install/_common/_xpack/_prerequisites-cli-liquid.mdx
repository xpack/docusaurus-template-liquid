...
Installing **{% if packageConfig.permalinkName %}{{packageConfig.permalinkName}}{% else %}{{packageName}}{% endif %}** requires:

- A recent version of [Node.js](https://nodejs.org) (specified as "engines.node": ">={{packageEnginesNodeVersion}}")
...
also **xpm**{% if packageConfig.permalinkName == 'xpm' %}, allowing you to safely skip the next section{% endif %}.
