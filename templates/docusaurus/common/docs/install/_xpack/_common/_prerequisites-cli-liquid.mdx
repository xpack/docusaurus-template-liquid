...
Installing **{% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}{{packageName}}{% endif %}** requires:
...
also **xpm**{% if packageConfig.shortName == 'xpm' %}, allowing you to safely skip the next section{% endif %}.
