...
{% if hasBranchMaster == "true" -%}
- `master`, {% if packageConfig.hasEmptyMaster == "true" %}not actively used{% else %}with the latest stable version (default){% endif %}{% endif %}{% if hasBranchDevelopment == "true" %}
