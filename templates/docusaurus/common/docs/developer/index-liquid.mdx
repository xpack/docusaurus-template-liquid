...
```sh
npm --prefix ~/Work/npm-packages/{{githubProjectName}}.git install
```
...
```sh
npm --prefix ~/Work/npm-packages/{{githubProjectName}}.git link
```
...
```sh
npm --prefix ~/Work/npm-packages/{{githubProjectName}}.git run compile-watch
```

{% if packageDependenciesTypescriptVersion != "" %}
...
```sh
npm --prefix ~/Work/npm-packages/{{githubProjectName}}.git install
npm --prefix ~/Work/npm-packages/{{githubProjectName}}.git run test
```
