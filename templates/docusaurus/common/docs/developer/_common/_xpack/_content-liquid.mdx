...
{%- if packageUseApiExtractor == "true" or packageWebsiteConfig.useApiDocumenter == "true" %}
{%- if isTypeScript == "true" %}
...
Windows and macOS, utilising node {{ packageConfig.githubActionsNodeVersions | join: ", " | replace_last: ", ", " and " }}.
