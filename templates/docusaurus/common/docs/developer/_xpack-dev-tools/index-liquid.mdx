...
title: Contributor's Guide{% if packageWebsiteConfig.customFields.usePluralGuides == "true" %}s{% endif %}
...
keywords:
  ...
  - prerequisites{% if packageWebsiteConfig.customFields.hasCustomDeveloper != "true" %}
  - repositories{% endif %}
  - build
...
{% if packageWebsiteConfig.customFields.hasCustomDeveloper == "true" %}

import CustomDeveloper from './_custom-developer.mdx'

{/* ------------------------------------------------------------------------ */}

# Contributor's Guide{% if packageWebsiteConfig.customFields.usePluralGuides == "true" %}s{% endif %}
...
# How to contribute to the xPack {{packageConfig.longName}}
