...
title: Contributor's Guide{% if customFields.usePluralGuides == "true" %}s{% endif %}
...
keywords:
  ...
  - prerequisites{% if customFields.hasCustomDeveloper != "true" %}
  - repositories{% endif %}
  - build
...
{% if customFields.hasCustomDeveloper == "true" %}

import CustomDeveloper from './_custom-developer.mdx'

{/* ------------------------------------------------------------------------ */}

# Contributor's Guide{% if customFields.usePluralGuides == "true" %}s{% endif %}
