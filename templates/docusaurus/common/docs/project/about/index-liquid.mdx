...
The {% if packageWebsiteConfig.shortName %}**{{packageWebsiteConfig.shortName}}**{% else %}**{{packageWebsiteConfig.longName}}**{% endif %} history is presented
...
{% assign last_word = packageWebsiteConfig.longName | split: " " | last | downcase %}
...
the **{{packageWebsiteConfig.longName}}**{% if last_word != "project" %} project{% endif %},
