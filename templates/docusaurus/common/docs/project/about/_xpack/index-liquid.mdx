...
# About {% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}the {{packageConfig.longName}}{% endif %}
...
The {% if packageConfig.shortName %}**{{packageConfig.shortName}}**{% else %}**{{packageConfig.longName}}**{% endif %} history is presented
