...
{% if packageConfig.shortName %}[{{packageScopedName}}](https://www.npmjs.com/package/{{packageScopedName}}) is a npm package available{% else %}The {{longXpackName}} is a npm package available as [{{packageScopedName}}](https://www.npmjs.com/package/{{packageScopedName}}){% endif %}
