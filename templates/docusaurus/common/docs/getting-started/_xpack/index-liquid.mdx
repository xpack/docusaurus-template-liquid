...
# Getting started with {% if packageConfig.shortName %}{{packageConfig.shortName}}{% else %}the {{packageConfig.longName}}{% endif %}
...
{% if packageConfig.shortName %}[{{packageScopedName}}](https://www.npmjs.com/package/{{packageScopedName}}) is a npm package available{% else %}The {{packageConfig.longName}} is a npm package available as [{{packageScopedName}}](https://www.npmjs.com/package/{{packageScopedName}}){% endif %}
