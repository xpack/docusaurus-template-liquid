...
# Getting started with {% if packageWebsiteConfig.shortName %}{{packageWebsiteConfig.shortName}}{% else %}the {{packageConfig.longName}}{% endif %}
...
{% if packageWebsiteConfig.shortName %}[{{packageScopedName}}](https://www.npmjs.com/package/{{packageScopedName}}) is a npm package available{% else %}The {{packageConfig.longName}} is a npm package available as [{{packageScopedName}}](https://www.npmjs.com/package/{{packageScopedName}}){% endif %}
