...
- **Star** {% if packageWebsiteConfig.customFields.isOrganizationWeb == "true" %}each project on GitHub{% else %}the project on [GitHub](https://github.com/xpack-dev-tools/{{gitHubProjectName}}/){% endif %}: It helps others discover our work.
