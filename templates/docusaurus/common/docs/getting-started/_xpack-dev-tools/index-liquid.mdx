...
The details of installing the various **{{longXpackName}}**
on various platforms are presented in the
**Install Guide** of each project web site.

{% else -%}

The details of installing the **{{longXpackName}}** on various platforms are
presented in the
...
[`{{githubProjectName}}.git/build-assets/scripts`](https://github.com/{{githubProjectOrganization}}/{{githubProjectName}}/tree/xpack/build-assets/scripts/)
folder. The scripts include common code from the [`@{{githubProjectOrganization}}/xbb-helper`](https://github.com/{{githubProjectOrganization}}/xbb-helper-xpack) package.
...
- **Star** {% if packageConfig.isOrganizationWeb == "true" %}each project on GitHub{% else %}the project on [GitHub](https://github.com/{{githubProjectOrganization}}/{{githubProjectName}}/){% endif %}: It helps others discover our work.
