...
{%- unless topConfig.hasNoGithubReleases %}
...
distribution of {{topConfig.upstreamDescriptiveName}},
intended for reproducible builds.

{%- else  %}

{% if websiteConfig.tagline != '' %}{{websiteConfig.tagline}}{% else %}{{ packageDescription }}{% endif %}.

{%- endif  %}

## Project documentation

For information on how to {% unless websiteConfig.skipInstallCommand %}install and {% endunless %}use this project, please refer to the
