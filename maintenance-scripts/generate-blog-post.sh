...
post_relative_file_path="blog/$(date '+%Y-%m-%d')-${xpack_top_config_permalink_name:-${xpack_package_name}}-v$(echo ${version} | tr '.' '-')-released.mdx"
...
xpack_binaries_folder_path="${HOME}/Downloads/xpack-binaries/${xpack_top_config_permalink_name}"

if [ "${xpack_is_xpack_binary}" ]
then
